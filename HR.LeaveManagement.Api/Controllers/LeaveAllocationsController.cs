...
namespace HR.LeaveManagement.Api.Controllers
{
    ...
    public class LeaveAllocationsController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<LeaveAllocationDetailsDto>> Get(string id)
        {
            var leaveAllocation = await _mediator.Send(new GetLeaveAllocationsDetailQuery { Id = id });
